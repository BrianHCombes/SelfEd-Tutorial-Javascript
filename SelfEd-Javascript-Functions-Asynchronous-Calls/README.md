...
Plunker | Citation
----------------------------------------------------------------------------|--------------------------------------------------------
[Run file: callback_Exp0.html](https://plnkr.co/edit/9kyuMzqQtq3Q3MP8mjGC?p=preview) | [Citation AAA - Credit to the author for this code structure](https://github.com/BrianHCombes/SelfEd-Tutorials-Javascript/blob/master/SelfEd-Javascript-Functions-Asynchronous-Calls/References.md)
