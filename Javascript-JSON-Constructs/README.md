...
**Catalyst:**       | The code would not work from tutorial: [**https://www.tutorialspoint.com/nodejs/nodejs_restful_api.htm**](https://www.tutorialspoint.com/nodejs/nodejs_restful_api.htm) The **Add User** section in the SelfEd project: [SelfEd-NodeJS-RESTful-API](https://github.com/BrianHCombes/SelfEd-Tutorials-NodeJS/tree/master/NodeJS-RESTful-API), involving the POST method would not work. Preliminary investigation suggests the JSON is not parsing properly.
